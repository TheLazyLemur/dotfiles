...
if [ "$1" = "$(aerospace list-workspaces --focused)" ]; then
    sketchybar --set $NAME background.drawing=on label.font="ComicShannsMono Nerd Font:Bold:22" \
    ...
    sketchybar --set $NAME background.drawing=off label.font="ComicShannsMono Nerd Font:Bold:18" \
