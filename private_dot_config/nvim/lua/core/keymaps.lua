...
map("n", "<leader>sf", function()
	Snacks.picker.files({ layout = MY_OPTS.vscode_bordered })
end)
map("n", "<leader>sg", function()
	Snacks.picker.grep({ layout = MY_OPTS.vscode_bordered })
end)
map("n", "<leader>gs", function()
	Snacks.picker.grep_word({ layout = MY_OPTS.vscode_bordered })
end)
map("n", "<leader><leader>", function()
	Snacks.picker.buffers({ layout = MY_OPTS.vscode_bordered })
end)
map("n", "<leader>/", function()
	Snacks.picker.lines({ layout = MY_OPTS.vscode_bordered })
end)
